...
class CurvatureEstimation
{
	...
	KDTree<Real> *kdtree;
public:
	CurvatureEstimation():knn(20),gauss(1.0),adaptive(0) {}
	inline void setParameters(size_t knn, Real gauss, int adaptive) {this->knn=knn; this->gauss=gauss; this->adaptive=adaptive;}
